...
final class DrinkInput
{
    ...
    {
        $text=['name'=>25,'remarks'=>6000,'buffname'=>50,'buffroundmsg'=>75,'buffwearoff'=>75,'buffeffectfailmsg'=>75,'buffeffectnodmgmsg'=>75,'buffeffectmsg'=>75];
        ...
        foreach ($modifiers as $key) {
            ...
            if ($value==='') $value='0';
            if (!preg_match('/\A-?(?:0|[1-9][0-9]{0,5})(?:\.[0-9]{1,6})?\z/',$value)) { throw new \InvalidArgumentException('Invalid drink modifier.'); }
            $values[$key]=$value;
        }
